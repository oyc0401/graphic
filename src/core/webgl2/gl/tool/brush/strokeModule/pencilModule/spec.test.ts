...
import { PencilModule } from "./index";

describe("pencilModule", () => {
  it("스펙을 만족해야 한다", () => {
    const _: () => void = () => {
      ...
      interface PencilModuleInterface {
      ...
      const module: PencilModuleInterface = PencilModule(gl, {
        alphaMapTexture,
        width,
        height,
      });
